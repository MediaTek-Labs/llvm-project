...
#define BCaseMask(X, M) IO.maskedBitSetCase(Value, #X, ELF::X, ELF::M)
  ...
  case ELF::EM_NANOMIPS:
    ...
    BCaseMask(E_NANOMIPS_ARCH_32R6, EF_NANOMIPS_ARCH);
    BCaseMask(E_NANOMIPS_ARCH_64R6, EF_NANOMIPS_ARCH);
    BCaseMask(E_NANOMIPS_ABI_P32, EF_NANOMIPS_ABI);
    BCaseMask(E_NANOMIPS_ABI_P64, EF_NANOMIPS_ABI);
    break;
  case ELF::EM_HEXAGON:
