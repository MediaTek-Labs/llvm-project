...
# RUN: ld.lld --relax --section-start .text=0x1000 --section-start .fix=0x7fff3600 --fix-nmips-hw110880 --expand-reg 6 %t.o -o %t
# RUN: %nanomips-elf-objdump -d %t | FileCheck %s
# RUN: ld.lld --relax --section-start .text=0x1000 --section-start .fix=0x79ff3600 --fix-nmips-hw110880 --expand-reg 6 %t.o -o %t
# RUN: %nanomips-elf-objdump -d %t | FileCheck %s

# RUN: ld.lld --relax --section-start .text=0x1000 --section-start .fix=0x78ff3600 --fix-nmips-hw110880 --expand-reg 6 %t.o -o %t
# RUN: %nanomips-elf-objdump -d %t | FileCheck --check-prefix=CHECK-NO-FIX %s

# RUN: ld.lld --relax --section-start .text=0x1000 --section-start .fix=0x7fff3900 --fix-nmips-hw110880 --expand-reg 6 %t.o -o %t
# RUN: %nanomips-elf-objdump -d %t | FileCheck --check-prefix=CHECK-NO-FIX %s
