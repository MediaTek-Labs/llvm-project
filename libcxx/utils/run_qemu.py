...
"""run_qemu.py is a utility for running a program with Qemu.
...
def main():
    ...
    parser.add_argument('--path_to_qemu', metavar='path_to_qemu', type=str, required=True)
    parser.add_argument('--cpu', metavar='cpu', type=str, default='I7200')
    ...
    # Run the qemu with the given environment in the execution directory.
    return subprocess.call(qemu, cwd=args.execdir, env=env, shell=False)
