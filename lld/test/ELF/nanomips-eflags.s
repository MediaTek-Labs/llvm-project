# llvm-objdump -p option doesn't work the same as
# nanomips-elf objdump
# Don't know how to pass pic to llvm-mc
# REQUIRES: nanomips, nanomips-gnu

# Only 32bit little endian is tested, as it is the only one supported for now
# RUN: llvm-mc -filetype=obj -triple nanomips-elf %s -o %t1.o
# RUN: llvm-mc -filetype=obj -triple nanomips-elf %S/Inputs/nanomips-eflags-sup.s -o %t2.o
