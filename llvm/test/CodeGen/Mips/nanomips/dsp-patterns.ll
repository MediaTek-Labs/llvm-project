...
; CHECK-LABEL: shift1_v2i16_sra_:
; CHECK: shra.ph $a{{[0-9]+}}, $a{{[0-9]+}}, 15
...
; CHECK-LABEL: shift1_v4i8_sra_:
; CHECK: shra.qb $a{{[0-9]+}}, $a{{[0-9]+}}, 7
