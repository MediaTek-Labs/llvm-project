...
; CHECK-NEXT:    ret void
; CHECK:       trap:
; CHECK-NEXT:    call void @llvm.ubsantrap(i8 3) #[[ATTR6:[0-9]+]], !nosanitize [[META0:![0-9]+]]
...
; CHECK-NEXT:    ret void
; CHECK:       trap:
; CHECK-NEXT:    call void @llvm.ubsantrap(i8 3) #[[ATTR6]], !nosanitize [[META0]]
; CHECK-NEXT:    unreachable, !nosanitize [[META0]]
;
...
; CHECK:       trap:
; CHECK-NEXT:    call void @llvm.ubsantrap(i8 5) #[[ATTR6]], !nosanitize [[META0]]
; CHECK-NEXT:    unreachable, !nosanitize [[META0]]
;
entry:
