...
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER_NANOMIPS  31
...
#define _LIBUNWIND_TARGET_NANOMIPS 1
  #define _LIBUNWIND_CONTEXT_SIZE 17
  #define _LIBUNWIND_CURSOR_SIZE 23
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER _LIBUNWIND_HIGHEST_DWARF_REGISTER_NANOMIPS
