...
# RUN: llvm-mc -filetype=obj -triple nanomips-elf -mattr=-pcrel \
# RUN: %S/Inputs/nanomips-abs-relocs-sup.s -o %t2.o

# RUN:  ld.lld --section-start .text=0x1000 --section-start .sdata=0x2001020 \
# RUN: %t1.o %t2.o -o %t
