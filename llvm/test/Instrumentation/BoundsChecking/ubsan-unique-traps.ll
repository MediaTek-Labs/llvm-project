...
; RUN: opt < %s -passes='bounds-checking<merge>' -S | FileCheck -check-prefix=MERGE %s
...
; CHECK-NEXT:    ret void
; CHECK:       trap:
; CHECK-NEXT:    call void @llvm.ubsantrap(i8 3) #[[ATTR3:[0-9]+]], !nosanitize [[META0:![0-9]+]]
; CHECK-NEXT:    unreachable, !nosanitize [[META0]]
; CHECK:       trap1:
; CHECK-NEXT:    call void @llvm.ubsantrap(i8 5) #[[ATTR3]], !nosanitize [[META0]]
; CHECK-NEXT:    unreachable, !nosanitize [[META0]]
; CHECK:       trap2:
; CHECK-NEXT:    call void @llvm.ubsantrap(i8 7) #[[ATTR3]], !nosanitize [[META0]]
; CHECK-NEXT:    unreachable, !nosanitize [[META0]]
;
...
; MERGE:    call void @llvm.ubsantrap(i8 3) #[[ATTR3:[0-9]+]], !nosanitize [[META0:![0-9]+]]
; MERGE: attributes #[[ATTR3]] = { noreturn nounwind }
