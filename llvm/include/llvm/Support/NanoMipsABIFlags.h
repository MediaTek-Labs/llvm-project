//===--- NanoMipsABIFlags.h - nanoMIPS ABI flags --------------------------===//
//
...
enum AFL_ASE {
  ...
  AFL_ASE_UNUSED1 = 0x00000002,   // was DSP R2 ASE
  AFL_ASE_EVA = 0x00000004,       // Enhanced VA Scheme
  AFL_ASE_MCU = 0x00000008,       // MCU (MicroController) extenstion
  AFL_ASE_UNUSED2 = 0x00000010,   // was MDMX ASE
  AFL_ASE_UNUSED3 = 0x00000020,   // was MIPS-3D ASE
  AFL_ASE_MT = 0x00000040,        // Multi-threading extension
  AFL_ASE_UNUSED4 = 0x00000080,   // was SmartMIPS ASE
  ...
  AFL_ASE_UNUSED6 = 0x00001000,   // was MIPS16 E2 Extension
  AFL_ASE_DSPR3 = 0x00002000,     // DSP R3 extension
  AFL_ASE_UNUSED5 = 0x00004000,   // was XPA
  AFL_ASE_CRC = 0x00008000,       // Cyclic Redundancy Check extenstion
  AFL_ASE_GINV = 0x00020000,      // Global INValidate extension
